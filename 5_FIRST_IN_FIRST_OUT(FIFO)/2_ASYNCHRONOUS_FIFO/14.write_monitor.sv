...
class async_fifo_wr_monitor extends uvm_monitor;
  ...
  uvm_analysis_port #(async_fifo_wr_transaction) wr_analysis_port;
   ...
   // default constructor
  function new(string name = "async_fifo_wr_monitor", uvm_component parent);
  ...
  task run_phase(uvm_phase phase);
    forever begin
      wr_trans = async_fifo_wr_transaction :: type_id :: create("wr_trans");		// object allocation by factory method
